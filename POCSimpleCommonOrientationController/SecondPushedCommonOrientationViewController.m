//
//  SecondPushedCommonOrientationViewController.m
...
@interface SecondPushedCommonOrientationViewController ()

@end

@implementation SecondPushedCommonOrientationViewController
