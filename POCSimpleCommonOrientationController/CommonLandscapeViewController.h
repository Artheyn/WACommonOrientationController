//
//  CommonLandscapeViewController.h
...
@interface CommonLandscapeViewController : UIViewController

@property (nonatomic, assign) CommonOrientationViewController *viewControllerShared;
